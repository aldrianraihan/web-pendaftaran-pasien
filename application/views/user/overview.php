    ...
    <section id="appointment" class="appointment section-bg">
      <div class="container">
        ...
        <div class="section-title">
          <br><h2>Make an Appointment</h2></td></br>
        </div>
        <form action="<?php echo base_url('/user/User_controller/input_appointment')?> " method="post" role="form" class="">
          <div class="form-row">
            ...
            <div class="col-md-4 form-group">
              <input type="text" class="form-control" name="no_telp" id="phone" placeholder="Your Phone" data-rule="minlen:4" data-msg="Please enter phone number">
              <div class="validate"></div>
            </div>
            <div class="col-md-4 form-group">
              <input type="text" class="form-control" name="petugas" id="petugas" placeholder="Petugas" data-rule="minlen:4" data-msg="Nama petugas">
              <input type="hidden" class="form-control" name="creator" value="<?php echo $this->session->userdata('username'); ?>">
              <input type="hidden" class="form-control" name="created" value="<?php echo date('Y-m-d H:i:s'); ?>">
            </div>
          </div>
          <div class="form-row">
            <textarea class="form-control" name="pesan" rows="5" placeholder="Message (Optional)"></textarea>
            <div class="validate"></div>
          </div>
          <div class="form-row">
            <br></br>
